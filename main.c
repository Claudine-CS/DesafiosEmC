    ...
    do{
        ...
        switch (opcao){
            case 1: {
                ...
                if (avioes[3] == 0){
                    for(i = 0; i < 4; i++){
                        printf ("\nCadastre o %d° aviao (apenas números): ", i + 1);
                ...
                if (avioes[0] != 0) {
                    ...
                    if (todosTemAssentos) {
                        ...
                        for(i = 0; i < 4; i++) {
                            ...
                            if (assentos[i] > 100){
                                printf("\nErro! O avião só pode ter no máximo 100 assentos!\n");
                                i--;
                            }
                        }
                    }
            ...
            case 3: 
                if (haAvioesDisponiveis(assentos, 4)) {
                    ...
                    for(i = 0; i < 4; i++) {
                        if (assentos[i] != 0) {
                            ...
                            printf("%04d: Sem passagens disponíveis.\n", avioes[i]);
                        }
                    }
                } else {
                ...
                if (aviaoEscolhido >= 1 && aviaoEscolhido <= 4 && assentos[aviaoEscolhido - 1] != 0) {
                    ...
                    if (passagensPorPessoa[indicePessoa] + numDePassagens > 20) {
            ...
            case 4:
                if (avioes[0] == 0 && avioes[1] == 0 && avioes[2] == 0 && avioes[3] == 0){
                    printf("\nAinda não há aviões cadastrados!\n");
                }else if(assentos[0] == 0 && assentos[1] == 0 && assentos[2] == 0 && assentos[3] == 0){
